...
from buche import H, Reader, Repl, CodeGlobals, BucheDb
...
class TestResult:
    ...
    def __hrepr__(self, H, hrepr):
        ...
        res = H.div['testresult',
            ...
            style=f'width: {width}px; height: {height}px; border-radius: {width/2}px'
        )
        return res
...
def pytest_sessionstart(session):
    ...
    buche.command_template(src='test_template.html')
    buche(H.script(
        """
        function tippy(x, y) {
            f = () => tippy(x, y);
